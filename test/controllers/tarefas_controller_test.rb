...
class TarefasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarefa" do
    assert_difference("Tarefa.count") do
      post tarefas_url, params: { tarefa: { completo: @tarefa.completo, descricao: @tarefa.descricao, titulo: @tarefa.titulo } }
    end
  ...
  test "should update tarefa" do
    patch tarefa_url(@tarefa), params: { tarefa: { completo: @tarefa.completo, descricao: @tarefa.descricao, titulo: @tarefa.titulo } }
